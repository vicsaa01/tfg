                    ...
                    <div class="col-lg-6 col-md-8">
                        ...
                        <form onSubmit={handleAdd}>
                            <div class="row mb-5 p-0 text-start">
                                ...
                                <input name="list" type="text" class="form-control" value={formData.list} onChange={handleInputChange} autoComplete="off" minlength="1" maxlength="80" required/>
                            </div>
