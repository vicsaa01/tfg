                                ...
                                <form action="/search" onSubmit={validateSearch}>
                                    <div class="row">
                                      <div class="col-3 p-0 m-0">
                                        <a href="/home"><img src="/img/en.png" class="" width="20" height="12"></img> In english</a>
                                      </div>
    ...
    return(
      <header>
              <div class="row">
                  <div class="navbar w-100 bg-dark">
                      <div class="col-lg-1 col-md-2 col-sm-3 col-xs-3">
                          <a class="navbar-brand ms-3 me-3" href="/home">
                              <img src='/img/logo.png' width="50" height="50"/>
                          </a>
                      </div>
                      ...
                      <div class="col-lg-5 col-md-0 col-sm-0 col-xs-0">
                        <div class="d-none d-lg-block">
                          <div class="row">
                            <div class="col">
                              <a class="boton-navbar btn d-none d-md-block pt-3 pb-3 rounded text-white text-center me-3" href="/en/music">Music</a>
                            </div>
                            <div class="col">
                              <a class="boton-navbar btn d-none d-md-block pt-3 pb-3 rounded text-white text-center me-3" href="/en/games">Games</a>
                            </div>
                            <div class="col">
                              <a class="boton-navbar btn d-none d-md-block pt-3 pb-3 rounded text-white text-center me-3" href="/en/movies">Movies</a>
                            </div>
                            <div class="col">
                              <a class="boton-navbar btn d-none d-md-block pt-3 pb-3 rounded text-white text-center me-3" href="/en/tv">TV</a>
                            </div>
                            <div class="col">
                              <a class="boton-navbar btn d-none d-md-block pt-3 pb-3 rounded text-white text-center me-3" href="/en/books">Books</a>
                            </div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="col-lg-1 col-md-2 col-sm-9 col-xs-3">
                                <div class="d-flex float-lg-end float-sm-start">
                                  <a class="boton-navbar btn pt-3 pb-3 rounded text-white text-center" href="/en/community">Community</a>
                                </div>
                              </div>
                        
                        <div class="col-lg-5 col-md-8 col-sm-12 col-xs-12">
                            <div class="d-flex justify-content-end">
                                <form action="/en/search" onSubmit={validateSearch}>
                                    <div class="row">
                                      <div class="col-3 p-0 m-0">
                                ...
                                <NavbarUserMenu isNavShown={props.isNavShown} lang={props.lang}/>
                            </div>
                      </div>
                  </div>
              </div>
