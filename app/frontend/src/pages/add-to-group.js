                    ...
                    <div class="col-6">
                        ...
                        <form onSubmit={handleAdd}>
                            <div class="row mb-5 p-0 text-start">
                                ...
                                <input name="group" type="text" class="form-control" value={formData.group} onChange={handleInputChange} required/>
                            </div>
                            ...
                            <div class="row p-0 mb-5">
                                ...
                                <div class="col-6 p-0 text-end">
                                    <button type="submit" class="btn w-50 bg-dark text-white">Añadir al grupo</button>
                                </div>                                
                            </div>
                        </form>
